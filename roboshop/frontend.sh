...
if [ $? -eq 0 ]; then
  echo ".....\e[32mngnix_Successfully_Enabled\e[0m"
else
  echo ".....\e[32mnginx_Enabling_Failed\e[0m"
fi

###echo -e "Starting Nginx\t\t\t.....\t\e[32mdone\e[0m"
systemctl start nginx &>>$LOG
if [ $? -eq 0 ]; then
  echo ".......\e[32mnginx_Successfully_Started\e[0m"
else
  echo "......\e[32mnginx_Starting_Failed\e[0m"
fi
###echo -e "Checking Status Nginx\t\t.....\t\e[32mdone\e[0m"
systemctl status nginx &>>$LOG
if [ $? -eq 0 ]; then
  echo ".....\e[32mnginx_Status_Checking\e[0m"
else
  echo ".....\e[32mnginx_Status_Checking_Failed\e[0m"
fi